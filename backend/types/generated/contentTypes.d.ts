...
export interface ApiActualiteActualite extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Actualit\u00E9, info conditions ou nouveaut\u00E9';
...
export interface ApiBaladeBalade extends Struct.CollectionTypeSchema {
  collectionName: 'balades';
  info: {
    description: 'Itin\u00E9raire VTT compos\u00E9 de un ou plusieurs chemins';
    displayName: 'Balade';
    pluralName: 'balades';
    singularName: 'balade';
  };
  ...
  attributes: {
    chemins: Schema.Attribute.Relation<'manyToMany', 'api::chemin.chemin'>;
    conseils: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    difficulte: Schema.Attribute.Enumeration<
      ['famille', 'intermediaire', 'expert']
    > &
      Schema.Attribute.Required;
...
export interface ApiCheminChemin extends Struct.CollectionTypeSchema {
  collectionName: 'chemins';
  info: {
    description: 'Tron\u00E7on VTT avec trace GPX';
    displayName: 'Chemin';
    pluralName: 'chemins';
    singularName: 'chemin';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    denivele_m: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    description_courte: Schema.Attribute.Text & Schema.Attribute.Required;
    distance_km: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    fichier_gpx: Schema.Attribute.Media<'files'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::chemin.chemin'
    ...
    publishedAt: Schema.Attribute.DateTime;
    statut: Schema.Attribute.Enumeration<['ouvert', 'deconseille', 'ferme']> &
      Schema.Attribute.Required &
